...
Future<void> servicesInjectionContainer() async {
  ...
  sl.registerLazySingleton<IsModelDownloadedUsecase>(
      () => IsModelDownloadedUsecase(sl()));

  sl.registerLazySingleton<TranslateTextUsecase>(
      () => TranslateTextUsecase(sl()));

  sl.registerLazySingleton<DownloadModelUsecase>(
      () => DownloadModelUsecase(sl()));

  sl.registerLazySingleton<GetSearchedCommentsUsecase>(
      () => GetSearchedCommentsUsecase(sl()));

  sl.registerLazySingleton<GetGeoFirePointUsecase>(() => GetGeoFirePointUsecase(sl()));
