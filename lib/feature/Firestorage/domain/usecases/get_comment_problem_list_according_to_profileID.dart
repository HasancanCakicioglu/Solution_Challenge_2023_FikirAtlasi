...
class GetCommentProblemListAccordingToProfileIDUsecase{
  ...
  Future<Either<FirebaseUnknowFailure, Tuple2<List<CommentProblemEntity?>,QueryDocumentSnapshot<Object?>?>>> call(String profileID,QueryDocumentSnapshot<Object?>? startAfter,{gettingData = 20})async{
    return await repository.getCommentProblemListAccordingToProfileID(profileID, startAfter,gettingData: gettingData);
  }
}