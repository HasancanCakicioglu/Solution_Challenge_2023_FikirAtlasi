...
class SpeacialForYouPageView extends StatefulWidget {
  const SpeacialForYouPageView({Key? key,required this.scrollControllerNested}) : super(key: key);
...
class _SpeacialForYouPageViewState extends State<SpeacialForYouPageView> with AutomaticKeepAliveClientMixin,SpeacialForYouPageMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: BlocBuilder<HomeSpecialForYouCubit,HomeSpecialForYouState>(builder: (context,state){
          if (state is HomeSpecialForYouLoading){
            ...
            return Column(
              children: [
                ...
                if(state.isLoadingNewData) const Center(child: CircularProgressIndicator()),
