...
class CommnetProblemSuggest extends StatefulWidget {
  const CommnetProblemSuggest({super.key, required this.problemID});
...
class _CommnetProblemSuggestState extends State<CommnetProblemSuggest> with CommentProblemPageMixin{
  @override
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return CommentsSuggestionCard(
                    commentSuggestionEntity: state.comments[index]!,
                  );
                },
              ),
            ),
